...
6. ### Segmented Customers Aged 30 or Older:
   Identified and analyzed orders made by customers aged 30 or older. Additionally, calculated the total number of unique customers using **DISTINCT()** and provided a list of countries involved.

## Result:
Generated comprehensive data-informed insights, empowering the marketing team with valuable information for targeted campaigns and enhanced customer engagement.
